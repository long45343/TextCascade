...
> **注意：** 自 v2.0.0 起本客户端使用 TextCascade v2 Token 协议（`POST /api/v1/login` + Bearer WebSocket，子协议 `textcascade.v1`），**不兼容 ClipCascade 服务端**。如需连接 ClipCascade（STOMP/CSRF），请使用 [v0.4.3 版本 Release](https://github.com/long45343/TextCascade/releases/tag/v0.4.3)。
